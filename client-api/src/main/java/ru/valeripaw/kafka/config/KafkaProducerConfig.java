...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, ClientRequestAvro> clientRequestKafkaTemplate() {
        return new KafkaTemplate<>(producerFactory());
    }

    public ProducerFactory<String, ClientRequestAvro> producerFactory() {
        ProducerProperties producerProperties = kafkaProperties.getClientRequestsEvent();
