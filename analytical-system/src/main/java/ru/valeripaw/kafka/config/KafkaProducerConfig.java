...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, RecommendationAvro> recommendationKafkaTemplate() {
        return new KafkaTemplate<>(producerFactory());
    }

    public ProducerFactory<String, RecommendationAvro> producerFactory() {
        ProducerProperties producerProperties = kafkaProperties.getRecommendationsEvent();
